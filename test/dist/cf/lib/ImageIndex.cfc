...
<cfcomponent accessors="true" output="true">
  ...
  <cfproperty name="elementClasses">
  ...
  <cfscript>
    ...
    public function init(required struct attributes) {
      instanceID = attributes.ELEMENTINFO.pageID;
      elementClasses = new ElementComponentClasses(attributes.ELEMENTINFO.ClassNames.Element);
      ...
      // Debugging
      // WriteDump(var = elementClasses, label = 'ImageIndex: elementClasses');

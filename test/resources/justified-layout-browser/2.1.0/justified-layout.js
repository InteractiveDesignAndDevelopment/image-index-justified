...
if ('object' === (typeof window === 'undefined' ? 'undefined' : _typeof(window)) && 'undefined' === typeof window.JustifiedLayout) {
  window.JustifiedLayout = JustifiedLayout;
}

},{"justified-layout":2}],2:[function(require,module,exports){
/*!
...
},{"./row":3,"merge":4}],3:[function(require,module,exports){
/*!
 * Copyright 2016 Yahoo Inc.
 * Licensed under the terms of the MIT license. Please see LICENSE file in the project root for terms.
 * @license
